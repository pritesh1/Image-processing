%%%%%%%%%%%%% The shadow1rotated.m file %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%
%Purpose:  
%     To transfer the input image(shadow1rotated) to an analazable image,
...
function [im11, im21, im31, im41] = shadow1rotated(a)
% a = imread('shadow1rotated.bmp');
...
subplot(1,3,2);
imshow(ff);
title('Binary image of shadow1rotated');
...
subplot(2,2,1);
imshow(R1);
title('Separated Region #1 of shadow1rotated');
subplot(2,2,2);
imshow(R2);
title('Separated Region #2 of shadow1rotated');
subplot(2,2,3);
imshow(R3);
title('Separated Region #3 of shadow1rotated');
subplot(2,2,4);
imshow(R4);
title('Separated Region #4 of shadow1rotated');
