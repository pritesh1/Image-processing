...
function [im11, im21, im31] = shadow2filter(f)
...
% display the 3 ROIs we obtained
figure;
subplot(2,2,1);
imshow(R1);
...
[a1,b1,c1,d1,e1,ff,g1,im11,im12,im13] = calculations(R1,m,n);
...
dat = {a1,b1,a1,d1,c1,b1,c1,d1,e1,ff,g1,im11,im12,im13;...
